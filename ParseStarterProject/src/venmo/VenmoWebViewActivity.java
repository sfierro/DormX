package venmo; //Replace this with your package name
			...
			case 1: {
				if(resultCode == RESULT_OK) {
					...
					if(signedrequest != null) {
						VenmoLibrary.VenmoResponse response = (new VenmoLibrary()).validateVenmoPaymentResponse(signedrequest, "yhAufgqZ9ZAuCUd4Sq3NrNKPL7a8kr6d");
