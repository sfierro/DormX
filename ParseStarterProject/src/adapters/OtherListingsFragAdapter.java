...
public class OtherListingsFragAdapter extends ParseQueryAdapter<Listing> {

    public OtherListingsFragAdapter (Context context) {
        super(context, new ParseQueryAdapter.QueryFactory<Listing>() {
            public ParseQuery<Listing> create() {
                ...
                query.whereEqualTo("category","Other");
