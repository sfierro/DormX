...
public class TicketsListingsFragAdapter extends ParseQueryAdapter<Listing> {

    public TicketsListingsFragAdapter (Context context) {
        super(context, new ParseQueryAdapter.QueryFactory<Listing>() {
            public ParseQuery<Listing> create() {
                ...
                query.whereEqualTo("category","Tickets");
