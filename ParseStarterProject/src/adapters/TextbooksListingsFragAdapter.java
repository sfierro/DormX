...
public class TextbooksListingsFragAdapter extends ParseQueryAdapter<Listing> {

    public TextbooksListingsFragAdapter (Context context) {
        super(context, new ParseQueryAdapter.QueryFactory<Listing>() {
            public ParseQuery<Listing> create() {
                ...
                query.whereEqualTo("category","Textbooks");
