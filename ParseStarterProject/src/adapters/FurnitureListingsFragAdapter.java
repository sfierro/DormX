...
public class FurnitureListingsFragAdapter extends ParseQueryAdapter<Listing> {

    public FurnitureListingsFragAdapter (Context context) {
        super(context, new ParseQueryAdapter.QueryFactory<Listing>() {
            public ParseQuery<Listing> create() {
                ...
                query.whereEqualTo("category","Furniture");
